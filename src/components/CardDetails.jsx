...
export const CardDetails = () => {
  ...
  const singleCardDetailsData = data.find((card) => card.id === cardId);
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-10">
        ...
        <div className="flex flex-col flex-grow md:w-2/3 pt-0 md:pt-4">
          ...
          <div className="flex flex-wrap items-center justify-start gap-x-6 gap-y-4 mb-6">
            ...
            {/* Ratings */}
            <div className="flex flex-col items-start">
              <p className="text-xs text-gray-500 uppercase font-medium">Average Ratings</p>
              <div className="flex items-center space-x-2">
            ...
            {/* Reviews */}
            <div className="flex flex-col items-start">
              <p className="text-xs text-gray-500 uppercase font-medium">Total Reviews</p>
              <div className="flex items-center space-x-2">
          ...
          {/* Install button */}
          <button
            onClick={() => handleInstall(cardId)}
            disabled={installed}
            className={`w-full md:w-[50%] px-8 py-4 text-white font-bold text-lg rounded-xl shadow-lg transition duration-300 ease-in-out mt-auto ${
              installed
